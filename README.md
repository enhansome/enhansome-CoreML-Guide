...
1. [Core ML Learning Resources](https://github.com/mikeroyal/CoreML-Guide#core-ml-learning-resources) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

2. [Core ML Tools, Libraries, and Frameworks](https://github.com/mikeroyal/CoreML-Guide#core-ml-tools-libraries-and-frameworks) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

3. [Apple Silicon](https://github.com/mikeroyal/CoreML-Guide#apple-silicon) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

4. [Algorithms](https://github.com/mikeroyal/CoreML-Guide#algorithms) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

5. [Machine Learning](https://github.com/mikeroyal/CoreML-Guide#machine-learning) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

6. [Computer Vision Development](https://github.com/mikeroyal/CoreML-Guide#computer-vision-development) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

7. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/CoreML-Guide#natural-language-processing-nlp-development) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

8. [Metal(API) Development](https://github.com/mikeroyal/CoreML-Guide#metal-api-development) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

9. [Swift Development](https://github.com/mikeroyal/CoreML-Guide#swift-development) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

10. [Objective-C Development](https://github.com/mikeroyal/CoreML-Guide#objective-c-development) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

11. [C/C++ Development](https://github.com/mikeroyal/CoreML-Guide#cc-development) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

12. [Python Development](https://github.com/mikeroyal/CoreML-Guide#python-development) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

# Awesome Core ML Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/CoreML-Guide#table-of-contents) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,268 | 🐛 709 | 🌐 Python | 📅 2026-08-20 for high performance training and inference.

[XGBoost](https://xgboost.readthedocs.io/) is an optimized distributed gradient boosting library designed to be highly efficient, flexible and portable. It implements machine learning algorithms under the Gradient Boosting framework. XGBoost provides a parallel tree boosting (also known as GBDT, GBM) that solve many data science problems in a fast and accurate way. It supports distributed training on multiple machines, including AWS, GCE, Azure, and Yarn clusters. Also, it can be integrated with Flink, Spark and other cloud dataflow systems.

[cuML](https://github.com/rapidsai/cuml) ⭐ 5,260 | 🐛 846 | 🌐 Python | 📅 2026-08-24 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,280 | 🐛 9,238 | 🌐 Swift | 📅 2026-08-24
...
[Kingfisher](https://github.com/onevcat/Kingfisher) ⭐ 24,392 | 🐛 173 | 🌐 Swift | 📅 2026-08-21 is a powerful, pure-Swift library for downloading and caching images from the web. It provides you a chance to use a pure-Swift way to work with remote images in your next app.
...
[Realm](https://github.com/realm/realm-cocoa) ⭐ 16,611 | 🐛 499 | 🌐 Objective-C | 📅 2026-06-14 is a mobile database(replaces Core Data & SQLite) that runs directly inside phones, tablets or wearables.

[Infer](https://github.com/facebook/infer) ⭐ 15,687 | 🐛 297 | 🌐 OCaml | 📅 2026-08-24 is a static analysis tool for Java, C++, Objective-C, and C.

[Mantle](https://github.com/Mantle/Mantle) ⭐ 11,255 | 🐛 0 | 🌐 Objective-C | 📅 2022-10-18 is a model framework that makes it easy to write a simple model layer for your Cocoa or Cocoa Touch application.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 15,987 | 🐛 686 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md) ⭐ 45,265 | 🐛 246 | 🌐 CSS | 📅 2026-08-06
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,392 | 🐛 1,186 | 🌐 CMake | 📅 2026-08-24 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Pipenv](https://github.com/pypa/pipenv) ⭐ 25,039 | 🐛 12 | 🌐 Python | 📅 2026-08-24 is a tool that aims to bring the best of all packaging worlds (bundler, composer, npm, cargo, yarn, etc.) to the Python world.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/CoreML-Guide/pulls) ⭐ 91 | 🐛 0 | 🌐 Swift | 📅 2022-02-06.
