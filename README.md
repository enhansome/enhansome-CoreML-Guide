...
1. [Core ML Learning Resources](https://github.com/mikeroyal/CoreML-Guide#core-ml-learning-resources) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

2. [Core ML Tools, Libraries, and Frameworks](https://github.com/mikeroyal/CoreML-Guide#core-ml-tools-libraries-and-frameworks) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

3. [Apple Silicon](https://github.com/mikeroyal/CoreML-Guide#apple-silicon) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

4. [Algorithms](https://github.com/mikeroyal/CoreML-Guide#algorithms) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

5. [Machine Learning](https://github.com/mikeroyal/CoreML-Guide#machine-learning) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

6. [Computer Vision Development](https://github.com/mikeroyal/CoreML-Guide#computer-vision-development) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

7. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/CoreML-Guide#natural-language-processing-nlp-development) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

8. [Metal(API) Development](https://github.com/mikeroyal/CoreML-Guide#metal-api-development) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

9. [Swift Development](https://github.com/mikeroyal/CoreML-Guide#swift-development) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

10. [Objective-C Development](https://github.com/mikeroyal/CoreML-Guide#objective-c-development) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

11. [C/C++ Development](https://github.com/mikeroyal/CoreML-Guide#cc-development) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

12. [Python Development](https://github.com/mikeroyal/CoreML-Guide#python-development) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06

# Awesome Core ML Learning Resources with stars

[Back to the Top](https://github.com/mikeroyal/CoreML-Guide#table-of-contents) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06
...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,290 | 🐛 710 | 🌐 Python | 📅 2026-08-28 for high performance training and inference.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,311 | 🐛 9,249 | 🌐 Swift | 📅 2026-08-29
...
[Kingfisher](https://github.com/onevcat/Kingfisher) ⭐ 24,394 | 🐛 170 | 🌐 Swift | 📅 2026-08-25 is a powerful, pure-Swift library for downloading and caching images from the web. It provides you a chance to use a pure-Swift way to work with remote images in your next app.
...
[Realm](https://github.com/realm/realm-cocoa) ⭐ 16,615 | 🐛 498 | 🌐 Objective-C | 📅 2026-06-14 is a mobile database(replaces Core Data & SQLite) that runs directly inside phones, tablets or wearables.

[Infer](https://github.com/facebook/infer) ⭐ 15,694 | 🐛 201 | 🌐 OCaml | 📅 2026-08-27 is a static analysis tool for Java, C++, Objective-C, and C.

[Mantle](https://github.com/Mantle/Mantle) ⭐ 11,256 | 🐛 0 | 🌐 Objective-C | 📅 2022-10-18 is a model framework that makes it easy to write a simple model layer for your Cocoa or Cocoa Touch application.

[Quick](https://github.com/Quick/Quick) ⭐ 9,829 | 🐛 49 | 🌐 Swift | 📅 2026-05-18 is a behavior-driven development framework for Swift and Objective-C.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 16,016 | 🐛 688 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,405 | 🐛 1,220 | 🌐 CMake | 📅 2026-08-29 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,543 | 🐛 50 | 🌐 C++ | 📅 2026-08-08 is a very fast, header-only/compiled, C++ logging library.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,467 | 🐛 336 | 🌐 Python | 📅 2024-12-17 is a command line HTTP client that makes CLI interaction with web services as easy as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
...
[Python Fire](https://github.com/google/python-fire) ⭐ 28,210 | 🐛 194 | 🌐 Python | 📅 2026-07-01 is a library for automatically generating command line interfaces (CLIs) from absolutely any Python object.
...
[spaCy](https://github.com/explosion/spaCy) ⭐ 33,862 | 🐛 236 | 🌐 Python | 📅 2026-08-24 is a library for advanced Natural Language Processing in Python and Cython.
...
* [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/CoreML-Guide/pulls) ⭐ 92 | 🐛 0 | 🌐 Swift | 📅 2022-02-06.
