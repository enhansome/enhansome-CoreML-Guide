...
[cuML](https://github.com/rapidsai/cuml) ⭐ 5,280 | 🐛 802 | 🌐 Python | 📅 2026-09-17 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,344 | 🐛 9,341 | 🌐 Swift | 📅 2026-09-17
...
[Vapor](https://github.com/vapor/vapor) ⭐ 26,196 | 🐛 83 | 🌐 Swift | 📅 2026-09-16 is a web framework for Swift. It provides a beautifully expressive and easy to use foundation for your next website, API, or cloud project.
...
[Mantle](https://github.com/Mantle/Mantle) ⭐ 11,248 | 🐛 0 | 🌐 Objective-C | 📅 2022-10-18 is a model framework that makes it easy to write a simple model layer for your Cocoa or Cocoa Touch application.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 16,125 | 🐛 693 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,464 | 🐛 1,131 | 🌐 CMake | 📅 2026-09-16 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,602 | 🐛 52 | 🌐 C++ | 📅 2026-09-05 is a very fast, header-only/compiled, C++ logging library.
...
[Luigi](https://github.com/spotify/luigi) ⭐ 18,774 | 🐛 178 | 🌐 Python | 📅 2026-07-18 is a Python module that helps you build complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization etc. It also comes with Hadoop support built-in.

[Locust](https://github.com/locustio/locust) ⭐ 28,163 | 🐛 5 | 🌐 Python | 📅 2026-09-15 is an easy to use, scriptable and scalable performance testing tool.

[spaCy](https://github.com/explosion/spaCy) ⭐ 33,902 | 🐛 243 | 🌐 Python | 📅 2026-08-24 is a library for advanced Natural Language Processing in Python and Cython.
