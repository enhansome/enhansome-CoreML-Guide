...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,323 | 🐛 9,248 | 🌐 Swift | 📅 2026-09-05
...
[Alamofire](https://github.com/Alamofire/Alamofire) ⭐ 42,425 | 🐛 44 | 🌐 Swift | 📅 2026-08-31 is an HTTP networking library written in Swift.
...
[Infer](https://github.com/facebook/infer) ⭐ 15,702 | 🐛 204 | 🌐 OCaml | 📅 2026-09-03 is a static analysis tool for Java, C++, Objective-C, and C.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 16,057 | 🐛 690 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,438 | 🐛 1,184 | 🌐 CMake | 📅 2026-09-04 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,575 | 🐛 47 | 🌐 C++ | 📅 2026-09-05 is a very fast, header-only/compiled, C++ logging library.
