...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,870 | 🐛 91 | 🌐 Markdown | 📅 2026-09-11 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,339 | 🐛 9,338 | 🌐 Swift | 📅 2026-09-12
...
[Kingfisher](https://github.com/onevcat/Kingfisher) ⭐ 24,392 | 🐛 171 | 🌐 Swift | 📅 2026-09-06 is a powerful, pure-Swift library for downloading and caching images from the web. It provides you a chance to use a pure-Swift way to work with remote images in your next app.
...
[Realm](https://github.com/realm/realm-cocoa) ⭐ 16,610 | 🐛 498 | 🌐 Objective-C | 📅 2026-06-14 is a mobile database(replaces Core Data & SQLite) that runs directly inside phones, tablets or wearables.

[Infer](https://github.com/facebook/infer) ⭐ 15,705 | 🐛 206 | 🌐 OCaml | 📅 2026-09-10 is a static analysis tool for Java, C++, Objective-C, and C.

[Mantle](https://github.com/Mantle/Mantle) ⭐ 11,250 | 🐛 0 | 🌐 Objective-C | 📅 2022-10-18 is a model framework that makes it easy to write a simple model layer for your Cocoa or Cocoa Touch application.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 16,085 | 🐛 690 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines/blob/master/CppCoreGuidelines.md) ⭐ 45,313 | 🐛 246 | 🌐 CSS | 📅 2026-08-06
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,461 | 🐛 1,114 | 🌐 CMake | 📅 2026-09-11 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[HTTPie](https://github.com/httpie/httpie) ⭐ 38,499 | 🐛 338 | 🌐 Python | 📅 2024-12-17 is a command line HTTP client that makes CLI interaction with web services as easy as possible. HTTPie is designed for testing, debugging, and generally interacting with APIs & HTTP servers.
