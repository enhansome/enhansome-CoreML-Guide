...
[Chainer](https://chainer.org/) is a Python-based deep learning framework aiming at flexibility. It provides automatic differentiation APIs based on the define-by-run approach (dynamic computational graphs) as well as object-oriented high-level APIs to build and train neural networks. It also supports CUDA/cuDNN using [CuPy](https://github.com/cupy/cupy) ⭐ 12,312 | 🐛 701 | 🌐 Python | 📅 2026-09-09 for high performance training and inference.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,331 | 🐛 9,302 | 🌐 Swift | 📅 2026-09-10
...
[Vapor](https://github.com/vapor/vapor) ⭐ 26,192 | 🐛 103 | 🌐 Swift | 📅 2026-09-09 is a web framework for Swift. It provides a beautifully expressive and easy to use foundation for your next website, API, or cloud project.
...
[Alamofire](https://github.com/Alamofire/Alamofire) ⭐ 42,421 | 🐛 45 | 🌐 Swift | 📅 2026-09-10 is an HTTP networking library written in Swift.
...
[Infer](https://github.com/facebook/infer) ⭐ 15,705 | 🐛 208 | 🌐 OCaml | 📅 2026-09-09 is a static analysis tool for Java, C++, Objective-C, and C.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 16,079 | 🐛 690 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,452 | 🐛 1,181 | 🌐 CMake | 📅 2026-09-10 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Locust](https://github.com/locustio/locust) ⭐ 28,138 | 🐛 4 | 🌐 Python | 📅 2026-09-07 is an easy to use, scriptable and scalable performance testing tool.
