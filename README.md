...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,878 | 🐛 87 | 🌐 Markdown | 📅 2026-09-25 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,406 | 🐛 9,389 | 🌐 Swift | 📅 2026-09-26
...
[Vapor](https://github.com/vapor/vapor) ⭐ 26,221 | 🐛 83 | 🌐 Swift | 📅 2026-09-25 is a web framework for Swift. It provides a beautifully expressive and easy to use foundation for your next website, API, or cloud project.
...
[Mantle](https://github.com/Mantle/Mantle) ⭐ 11,245 | 🐛 0 | 🌐 Objective-C | 📅 2022-10-18 is a model framework that makes it easy to write a simple model layer for your Cocoa or Cocoa Touch application.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 16,183 | 🐛 696 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,485 | 🐛 1,101 | 🌐 CMake | 📅 2026-09-25 is a C++ Library Manager for Windows, Linux, and MacOS.
