...
[cuML](https://github.com/rapidsai/cuml) ⭐ 5,261 | 🐛 852 | 🌐 Python | 📅 2026-08-25 is a suite of libraries that implement machine learning algorithms and mathematical primitives functions that share compatible APIs with other RAPIDS projects. cuML enables data scientists, researchers, and software engineers to run traditional tabular ML tasks on GPUs without going into the details of CUDA programming. In most cases, cuML's Python API matches the API from scikit-learn.
...
[Swift Evolution](https://github.com/apple/swift-evolution) ⭐ 15,868 | 🐛 79 | 🌐 Markdown | 📅 2026-08-25 maintains proposals for changes and user-visible enhancements to the Swift Programming Language.
...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,289 | 🐛 9,234 | 🌐 Swift | 📅 2026-08-25
...
[Vapor](https://github.com/vapor/vapor) ⭐ 26,193 | 🐛 116 | 🌐 Swift | 📅 2026-08-25 is a web framework for Swift. It provides a beautifully expressive and easy to use foundation for your next website, API, or cloud project.
...
[Perfect](https://github.com/PerfectlySoft/Perfect) ⭐ 13,743 | 🐛 65 | 🌐 Swift | 📅 2024-02-03 is a complete and powerful toolbox, framework, and application server for Linux, iOS, and macOS (OS X). It provides everything a Swift engineer needs for developing lightweight, maintainable, and scalable apps and other REST services entirely in the Swift programming language for both client-facing and server-side applications.
...
[Infer](https://github.com/facebook/infer) ⭐ 15,689 | 🐛 293 | 🌐 OCaml | 📅 2026-08-25 is a static analysis tool for Java, C++, Objective-C, and C.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 15,989 | 🐛 686 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[Locust](https://github.com/locustio/locust) ⭐ 28,098 | 🐛 3 | 🌐 Python | 📅 2026-08-24 is an easy to use, scriptable and scalable performance testing tool.

[spaCy](https://github.com/explosion/spaCy) ⭐ 33,847 | 🐛 237 | 🌐 Python | 📅 2026-08-24 is a library for advanced Natural Language Processing in Python and Cython.
