...
[Swift GitHub](https://github.com/apple/swift) ⭐ 70,275 | 🐛 9,220 | 🌐 Swift | 📅 2026-08-22
...
[Realm](https://github.com/realm/realm-cocoa) ⭐ 16,613 | 🐛 499 | 🌐 Objective-C | 📅 2026-06-14 is a mobile database(replaces Core Data & SQLite) that runs directly inside phones, tablets or wearables.

[Infer](https://github.com/facebook/infer) ⭐ 15,685 | 🐛 297 | 🌐 OCaml | 📅 2026-08-21 is a static analysis tool for Java, C++, Objective-C, and C.
...
[Hammerspoon](https://github.com/Hammerspoon/hammerspoon) ⭐ 15,968 | 🐛 686 | 🌐 Objective-C | 📅 2026-07-08 is a tool for powerful automation for macOS that acts as a bridge between the operating system and a Lua scripting engine.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,385 | 🐛 1,164 | 🌐 CMake | 📅 2026-08-22 is a C++ Library Manager for Windows, Linux, and MacOS.
...
[Spdlog](https://github.com/gabime/spdlog) ⭐ 29,515 | 🐛 49 | 🌐 C++ | 📅 2026-08-08 is a very fast, header-only/compiled, C++ logging library.
